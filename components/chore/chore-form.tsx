...
import { CalendarDays, Loader2, Plus, Repeat, User } from 'lucide-react';
...
export default function ChoreForm({
  ...
  const watchedRecurringInterval = watch('recurring_interval');
    ...
    <Card className="w-full max-w-2xl border-none shadow-none">
      <CardHeader className="pb-4 sm:pb-6">
        <CardTitle className="flex items-center gap-2 text-lg sm:text-xl">
          ...
          {mode === 'create' ? 'Add New Chore' : 'Edit Chore'}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <form
          ...
          >
            ...
            >
              <SelectTrigger
                className={cn(
                  'w-full h-11 sm:h-10 text-base sm:text-sm',
                  errors.recurring_type && 'border-red-500'
                )}
              >
                <SelectValue />
              </SelectTrigger>
              ...
              {showRecurringInterval && (
                ...
                >
                  ...
                  <Input
                    ...
                    value={watchedRecurringInterval || 1}
                    className={cn(
                      'w-20 h-10 sm:h-9 text-base sm:text-sm',
                      errors.recurring_interval && 'border-red-500'
                    )}
                  />
